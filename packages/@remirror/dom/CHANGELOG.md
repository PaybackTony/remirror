...
- [`0876a5cc`](https://github.com/remirror/remirror/commit/0876a5cc8cedb1f99e72ab7684b5478b3402b9e7) [#678](https://github.com/remirror/remirror/pull/678) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Add `tr` and `transactions` property to `onStateUpdate` for DOM framework implementation.
...
- [`27b358e4`](https://github.com/remirror/remirror/commit/27b358e4cb877a1e8df61c9d5326f366e66f30dc) [#668](https://github.com/remirror/remirror/pull/668) Thanks [@ifiokjr](https://github.com/ifiokjr)! - Support lazy functions which return an extension list in the `createDomManager`.
