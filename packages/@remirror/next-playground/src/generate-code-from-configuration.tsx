...
function generateName(str: string): string {
  const base = str
    .replace(/[^\da-z]/gi, '-')
    .replace(/^-+|-+$/g, '')
...
/**
 * When configuring the playground, in the background you are dynamically
 * editing the code that will rendered in the DOM.
 *
 * TODO this should be moved into the playground entry point for each framework
 * library.
 */
export function generateCodeFromConfiguration(codeOptions: CodeOptions): string {
